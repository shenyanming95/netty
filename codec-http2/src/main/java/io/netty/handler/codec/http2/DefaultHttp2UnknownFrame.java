...
public final class DefaultHttp2UnknownFrame extends DefaultByteBufHolder implements Http2UnknownFrame {
    ...
    public String toString() {
        return StringUtil.simpleClassName(this) + "(frameType=" + frameType + ", stream=" + stream + ", flags=" + flags + ", content=" + contentToString() + ')';
    }
    ...
    public boolean equals(Object o) {
        ...
        return (stream == otherStream || otherStream != null && otherStream.equals(stream)) && flags.equals(other.flags()) && frameType == other.frameType() && super.equals(other);
    }
