...
public class HAProxyTLV extends DefaultByteBufHolder {
    ...
    public String toString() {
        return StringUtil.simpleClassName(this) + "(type: " + type() + ", typeByteValue: " + typeByteValue() + ", content: " + contentToString() + ')';
    }
     ...
     */
    public enum Type {
        PP2_TYPE_ALPN, PP2_TYPE_AUTHORITY, PP2_TYPE_SSL, PP2_TYPE_SSL_VERSION, PP2_TYPE_SSL_CN, PP2_TYPE_NETNS,
        /**
