...
public final class Http2ClientFrameInitializer extends ChannelInitializer<Channel> {
    ...
    protected void initChannel(Channel ch) throws Exception {
        ...
        final Http2FrameCodec http2FrameCodec = Http2FrameCodecBuilder.forClient().initialSettings(Http2Settings.defaultSettings()) // this is the default, but shows it can be changed.
                .build();
